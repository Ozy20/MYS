...
function SideNav({ userRole }) {
    ...
    const selectedOption = userRole === 'manager' ? 'Dashboard' : 'My Tasks';
    ...
    return (
        <>
            <div id="header">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#4A628A" class="bi bi-list-task" viewBox="0 0 16 16">
...

            {
                userRole === 'manager' ?
                    <div id="nav">
                        ...
                        <div 
                            className={`nav-option ${selectedOption === 'Assign Task' ? 'selected' : ''}`}
                            onClick={() => handleNavClick('/app/assign-task')}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div id="nav">
                        <div 
                            className={`nav-option ${selectedOption === 'My Tasks' ? 'selected' : ''}`}
                            onClick={() => handleNavClick('/app/my-tasks')}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div 
                            className={`nav-option ${selectedOption === 'Reports' ? 'selected' : ''}`}
